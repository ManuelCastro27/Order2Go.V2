...
{
    public partial class Order2GoV2 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Orden_Restaurante_RestauranteIdRestaurante",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IdRestaurante = table.Column<int>(type: "int", nullable: false),
                    RestaurantesIdRestaurante = table.Column<int>(type: "int", nullable: true),
                    Discriminator = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Cantidad = table.Column<float>(type: "real", nullable: true),
                    VentaTotal = table.Column<decimal>(type: "decimal(18,2)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DetalleOrden_Orden_OrdenIdOrden",
                        column: x => x.OrdenIdOrden,
                        principalTable: "Orden",
                        principalColumn: "IdOrden",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_DetalleOrden_Producto_ProductoIdProducto",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DetalleOrden_OrdenIdOrden",
                table: "DetalleOrden",
                column: "OrdenIdOrden");

            migrationBuilder.CreateIndex(
                name: "IX_DetalleOrden_ProductoIdProducto",
                table: "DetalleOrden",
                column: "ProductoIdProducto");

            migrationBuilder.CreateIndex(
                name: "IX_Orden_RestauranteIdRestaurante",
                table: "Orden",
